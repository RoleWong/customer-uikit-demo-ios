...
//  customer_uikit_demo
//
//  Created by Role Wong on 8/6/24.
//

#ifndef GenerateTestUserSig_h
#define GenerateTestUserSig_h
...
static NSString * const test_userID = @"";

static NSString * const customer_service_id = @"@customer_service_account";
